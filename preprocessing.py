...
from config import ModelType, PreProcessType
...
def preprocess_text(
    data: pd.DataFrame,
    model_type: str = ModelType.XLMSequenceClf,
    ...
    # [개체1][SEP][개체2][SEP][개체 각각 스페셜토큰이 부착된 제시문]
        ...
        if model_type in [
            ...
            data["input"] = data["e1"] + ST.SEP + data["e2"] + ST.SEP + data["input"]
    else:
